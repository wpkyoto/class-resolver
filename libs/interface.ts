 ...
 * Higher priority values are executed first
 */
export interface PrioritizedResolveTarget<
  TArgs extends any[] = any[],
  TReturn = any,
  TType = string,
> extends ResolveTarget<TArgs, TReturn, TType>,
    HasPriority {}
 ...
 * Higher priority values are executed first
 */
export interface PrioritizedAsyncResolveTarget<
  TArgs extends any[] = any[],
  TReturn = any,
  TType = string,
> extends AsyncResolveTarget<TArgs, TReturn, TType>,
    HasPriority {}
